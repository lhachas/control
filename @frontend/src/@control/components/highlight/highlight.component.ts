...
import '@control/components/highlight/prism-languages';

@Component({
    selector : 'control-highlight',
    template : '',
    styleUrls: ['./highlight.component.scss']
})
export class ControlHighlightComponent implements OnInit, OnDestroy
{
    // Source
    ...
    highlight(sourceCode): void
    {
        ...
        // can be formatted properly while using control-highlight
        // component
