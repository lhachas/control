...
export class ControlWidgetComponent implements AfterContentInit
{
    @HostBinding('class.flipped')
    flipped = false;

    @ContentChildren(ControlWidgetToggleDirective, {descendants: true})
    toggleButtons: QueryList<ControlWidgetToggleDirective>;
