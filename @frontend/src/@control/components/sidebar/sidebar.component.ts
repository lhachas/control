...
import { ControlSidebarService } from './sidebar.service';
...
export class ControlSidebarComponent implements OnInit, OnDestroy
{
    ...
    ngOnInit(): void
    {
        ...
        this._controlSidebarService.register(this.name, this);
    ...
    ngOnDestroy(): void
    {
        ...
        this._controlSidebarService.unregister(this.name);
    ...
    private _showBackdrop(): void
    {
        ...
        this._backdrop.classList.add('control-sidebar-overlay');

        // Add a class depending on the invisibleOverlay option
        if ( this.invisibleOverlay )
        {
            this._backdrop.classList.add('control-sidebar-overlay-invisible');
        }
