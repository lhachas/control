...
export class ControlInnerScrollDirective implements OnInit, OnDestroy
{
    // Private
    private _parent: any;
     ...
     * @param {ControlMatchMediaService} _controlMediaMatchService
     * @param {Renderer2} _renderer
     */
    constructor(
        private _elementRef: ElementRef,
        private _controlMediaMatchService: ControlMatchMediaService,
    ...
    ngOnInit(): void
    {
        ...
        this._controlMediaMatchService.onMediaChange
