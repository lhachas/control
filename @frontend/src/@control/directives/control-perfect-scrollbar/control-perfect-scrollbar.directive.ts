...
import { ControlPerfectScrollbarGeometry, ControlPerfectScrollbarPosition } from '@control/directives/control-perfect-scrollbar/control-perfect-scrollbar.interfaces';
import { ControlConfigService } from '@control/services/config.service';

@Directive({
    selector: '[controlPerfectScrollbar]'
})
export class ControlPerfectScrollbarDirective implements OnInit, AfterViewInit, OnDestroy
{
     ...
     */
    @Input()
    set controlPerfectScrollbarOptions(value)
    {
        // Merge the options
    ...
    get controlPerfectScrollbarOptions(): any
    {
        // Return the options
    ...
    ngAfterViewInit(): void
    {
        ...
        if ( this.controlPerfectScrollbarOptions.updateOnRouteChange )
        {
            this._router.events
                .pipe(
                    takeUntil(this._unsubscribeAll),
    ...
    _init(): void
    {
        ...
        this.ps = new PerfectScrollbar(this.elementRef.nativeElement, {
            ...this.controlPerfectScrollbarOptions
        });
     ...
     * @param prefix
     */
    geometry(prefix: string = 'scroll'): ControlPerfectScrollbarGeometry
    {
        return new ControlPerfectScrollbarGeometry(
     ...
     * @param absolute
     */
    position(absolute: boolean = false): ControlPerfectScrollbarPosition
    {
        if ( !absolute && this.ps )
        {
            return new ControlPerfectScrollbarPosition(
                this.ps.reach.x || 0,
                this.ps.reach.y || 0
            );
        }
