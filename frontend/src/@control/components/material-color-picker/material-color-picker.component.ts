...
import { MatColors } from '@control/mat-colors';
import { ControlValueAccessor, NG_VALUE_ACCESSOR } from '@angular/forms';

export const CONTROL_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR: any = {
...
@Component({
    selector     : 'control-material-color-picker',
    templateUrl  : './material-color-picker.component.html',
    styleUrls    : ['./material-color-picker.component.scss'],
    animations   : controlAnimations,
    encapsulation: ViewEncapsulation.None,
    providers    : [CONTROL_MATERIAL_COLOR_PICKER_VALUE_ACCESSOR]
})
export class ControlMaterialColorPickerComponent implements ControlValueAccessor
{
    colors: any;
    hues: string[];
    view: string;
    ...
    set color(value)
    {
        ...
        // Split the color value (red-400, blue-500, control-navy-700 etc.)
