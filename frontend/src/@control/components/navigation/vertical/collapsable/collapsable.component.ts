...
@Component({
    selector   : 'control-nav-vertical-collapsable',
    templateUrl: './collapsable.component.html',
    styleUrls  : ['./collapsable.component.scss'],
    animations : controlAnimations
})
export class ControlNavVerticalCollapsableComponent implements OnInit, OnDestroy
{
    @Input()
    ...
    ngOnInit(): void
    {
        ...
        this._controlNavigationService.onItemCollapsed
    ...
    toggleOpen(ev): void
    {
        ...
        this._controlNavigationService.onItemCollapsed.next(this.item);
        this._controlNavigationService.onItemCollapseToggled.next();
    }
