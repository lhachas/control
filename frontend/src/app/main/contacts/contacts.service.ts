...
export class ContactsService implements Resolve<any>
{
    ...
    /**
     * @description Consulta de Documentos [RENIEC][SUNAT]
     * @param ruc [string]
     * @returns [Promise<Contribuyente>]
     */
    async consultaRuc(ruc: string): Promise<Contribuyente> {
        const contribuyente: any = await this._httpClient.get('api/v1/ruc/' + ruc).toPromise();
    ...
    updateContact(contact): Promise<any>
    {
        return new Promise((resolve, reject) => {
            ...
            this._httpClient.post('api/v1/contacto/actualizar/' + contact.id, {...contact})
                .subscribe(response => {
                    this.getContacts();
                    resolve(response);
                });
