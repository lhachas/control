...
import { RDocumento, CDR } from '@fe/common/exchange';
import { ISerializador, IEstructuraXml } from '@fe/common/interfaces';
...
export class Serializador implements ISerializador {
     ...
     *
     */
    public GenerarXml(estructuraXml: IEstructuraXml): RDocumento {
        const documento = new RDocumento();
        try {
